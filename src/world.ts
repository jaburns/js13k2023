...
//export let worldSourceList:[number,string[]][]=[[0,["box","0","0","-1000","1500","1026","1000","2000","0","0","0","0"]],[0,[""]],[0,["box","1","0","321","1211","1326","360","835","0","0","0","200"]],[0,["sub"]],[0,[""]],[0,[""]],[0,[""]],[0,["castle","-400","300","2200"]],[0,["castle","0","350","2200"]],[0,["castle","400","300","2200"]],[0,[""]],[0,[""]]]
let loadLevelQuarter=()=>[csgSolidBake(csgSolidOpSubtract(csgSolidBox(0,0,-1000,1500,1026,1000,2000,0,0,0,0),csgSolidBox(1,0,321,1211,1326,360,835,0,0,0,200))),[[-400,300,2200],[0,350,2200],[400,300,2200]]]
...
export let hints = [
    ...
    'SHOOT INTO THE AIR',
    'USE THE QUARTER PIPE',
    'BLAST THROUGH THE WALL',


    'BANK AROUND THE CORNER',
    'GET MOMENTUM DOWN THE RAMP',
    'RIDE THE TUNNEL',
]
